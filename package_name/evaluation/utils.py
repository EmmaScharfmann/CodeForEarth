...
def _get_labels_from_encoder_output(encoder_output: dict):
    """
...
def get_input_labels(vae: VAE,
    ...
    :param vae: The CMM-VAE used to calculate cluster assigments
    :return: An array of cluster labels for each time step.
    """
    ...
    labels = _get_labels_from_encoder_output(encoder_output)
...
def calculate_cluster_centers(vae: VAE) -> np.ndarray:
    ...
    :return: The cluster centers in input space (array of shape cluster number times input size)
    """
    dummy_input = {
